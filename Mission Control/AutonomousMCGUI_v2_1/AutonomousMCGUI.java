...
public class AutonomousMCGUI {
	...
	public AutonomousMCGUI(AnchorPane anchorPane) {
		...
		solidWhiteBackground.setOnAction(e -> {
			myBackground = new Background(new BackgroundFill(Color.GHOSTWHITE, null, null));
			anchorPane.setBackground(myBackground);
		});
		...
		AnchorPane.setLeftAnchor(dialDisplay, 150.0);
		AnchorPane.setRightAnchor(dialDisplay, 150.0);
